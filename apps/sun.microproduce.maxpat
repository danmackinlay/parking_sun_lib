	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 510.0, 300.0, 68.0, 20.0 ],
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "signal" ],
					"id" : "obj-19"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 690.0, 270.0, 50.0, 20.0 ],
					"numoutlets" : 2,
					"fontname" : "Arial",
					"outlettype" : [ "float", "bang" ],
					"id" : "obj-17"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 645.0, 300.0, 50.0, 20.0 ],
					"numoutlets" : 2,
					"fontname" : "Arial",
					"outlettype" : [ "float", "bang" ],
					"id" : "obj-15"
...
, 			{
				"box" : 				{
					"maxclass" : "scope~",
					"numinlets" : 2,
					"patching_rect" : [ 615.0, 405.0, 130.0, 130.0 ],
					"numoutlets" : 0,
					"bufsize" : 243,
					"trigger" : 1,
					"id" : "obj-35"
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sun.curvemodulator~",
					"fontsize" : 12.0,
					"numinlets" : 6,
					"patching_rect" : [ 615.0, 360.0, 123.0, 20.0 ],
					"numoutlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "poly~ sun.simplesample 8 args spang",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 210.0, 360.0, 212.0, 20.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
					"id" : "obj-2"
				}
