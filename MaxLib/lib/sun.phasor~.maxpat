...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 130.0, 180.0, 158.0 ],
					"text" : "sun.phasor is a outputs a normal (0-1) phasor and, in lockstep, a constant-rate ramp, suitable for e.g. driving granualar synthesizers without pitch shift when you vary the grain rate.\n\nThis one is like sun.phasor but with a signal rate input for frequency."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 130.0, 380.0, 63.5, 20.0 ],
					"text" : "+=~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 130.0, 110.0, 61.0, 20.0 ],
					"text" : "/~ 44100."
				}
