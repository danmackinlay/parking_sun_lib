...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 14.0, 220.0, 57.0 ],
					"prototypename" : "M4L.patcher-summary",
					"text" : "Frequency-domain pitch shifter for pfft~. Adapted from M4L.transp.pfft~ to work in halfsteps and S&H tranpose values"
				}
