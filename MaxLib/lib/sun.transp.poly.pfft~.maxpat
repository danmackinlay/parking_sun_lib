...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 216.0, 240.0, 47.0, 18.0 ],
					"text" : "thresh~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 152.0, 184.0, 50.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.0, 160.0, 67.0, 18.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 176.0, 85.0, 18.0 ],
					"text" : "loadmess clip 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 8.0, 201.0, 27.0 ],
					"prototypename" : "M4L.subpatcher-title",
					"text" : "sun.transp.poly.pfft~",
					"textcolor" : [ 0.3, 0.34, 0.4, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 328.0, 192.0, 100.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 347.0, 216.0, 23.0, 18.0 ],
					"text" : "Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 299.0, 216.0, 48.0, 18.0 ],
					"prototypename" : "Live",
					"triscale" : 0.75
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.0, 241.0, 64.0, 16.0 ],
					"text" : "freqshift $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.0, 192.0, 28.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.0, 136.0, 106.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 88.0, 272.0, 46.0, 18.0 ],
					"text" : "gizmo~"
				}
